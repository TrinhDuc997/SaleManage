...
export default class screenDSNhaCungCapCpn extends Component {
  constructor(props) {
    super(props);
  }
  ...
  handleSelect = (item) => {
    ...
    navigation.navigate("themDonHang",{supplier:item})
  }
  data = [
    {key:1,id:1 ,supplierCode:'SP01',supplierName:'Đại lý gạo Tiền Giang',address:'Tiền Giang',telephone:'0909995895',trangThai:"Hoàn Thành",icon:faListAlt,handleSelect:this.handleSelect},
    {key:2,id:2 ,supplierCode:'SP02',supplierName:'Đại lý gạo Bình Phước',address:'Binh Phước',telephone:'0909924825',trangThai:"Hoàn Thành",icon:faListAlt,handleSelect:this.handleSelect},
    {key:3,id:3 ,supplierCode:'SP03',supplierName:'Vựa gạo Long An',address:'Long An',telephone:'0909945872',trangThai:"Hoàn Thành",icon:faListAlt,handleSelect:this.handleSelect},
    ]
  render() {
    return (
